...
class OOD_detec_class:
    ...
    def __init__(self, num_classes=3):
        ...
        self.th_dict = {'zscore': deepcopy(alpha_dict), 'maha_dist': deepcopy(alpha_dict),
    ...
    def train_OOD(self, X, y, K=5, val_size=0.2, rng=42):
        ...
        for k in range(K):
            ...
            # Initialize model
            self.model = MLPClassifier(hidden_layer_sizes=(32,), random_state=seed_k, max_iter=1000, verbose=False)
            # self.model = GaussianProcessClassifier(kernel=self.kernel, random_state=seed_k, max_iter_predict=100)
            # self.model = LogisticRegression(penalty=None, random_state=seed_k, max_iter=1000)
